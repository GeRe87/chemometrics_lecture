Reveal.addEventListener('slidechanged', function (event) {
    ...
    if (event.currentSlide.querySelector('#chart_meanValue2')) {
        const ctx = document.getElementById('chart_meanValue2');
        ...
        for (let i = 0; i < data.length; i += 50) {
            for (let u = 0; u < 50; u++) {
                ...
                dataMean.push({ x: data[i].x, y: sum / 50 });
            }
        }
        ...
        chartInstance = new Chart(ctx, {
            ...
            data: {
                datasets: [{
                    ...
                    radius: 0,
                    data: dataMean,
                    label: 'Mean Value of 50 Data Points',
                },
                {
