function createExponentialRegressionChartWithUncertainties2() {
    // Data points
    const data = [
        { x: 1, y: 2.718 },
        { x: 2, y: 7.389 },
    ...
    const svg = createSVG('chart_with_uncertainties2', width, height, margin);
    ...
    updateChart(10); // Adjust the number of iterations as needed

    // Optionally, add a slider to adjust iterations
}

createExponentialRegressionChartWithUncertainties2();
